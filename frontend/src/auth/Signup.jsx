            ...
            <form className="mobile-auth-form" onSubmit={handleRegister}>
              ...
              {selectedRole === 'Hospital' && (
                <>
                  ...
                  <label className="mobile-auth-label" style={{fontWeight:'500', fontSize:'0.85rem', marginBottom:'0.45rem', display:'block'}}>Phone Number</label>
                  <input type="tel" placeholder="Enter phone number" value={hospitalContact} onChange={e => setHospitalContact(e.target.value)} required style={{width:'100%', padding:'0.8rem 1.2rem', borderRadius:'1.2rem', border:'1px solid #e5e7eb', background:'#f3f4f6', fontSize:'1rem', marginBottom:'0.8rem', boxSizing:'border-box'}} />
